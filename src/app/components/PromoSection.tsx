    ...
    <section className="py-0 bg-[#F5F0EB]">
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="relative flex-1 min-h-[420px] md:min-h-[580px]">
          <img
            src="https://images.unsplash.com/photo-1722410180644-5955f83ec8b1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHw1fHxmaW5lJTIwamV3ZWxyeSUyMGdvbGQlMjBuZWNrbGFjZSUyMG1pbmltYWx8ZW58MXx8fHwxNzgzMjc4MzkzfDA&ixlib=rb-4.1.0&q=80&w=900"
            ...
            {[
              ...
              <div key={item.label}>
                <p
                  ...
                  style={{ fontFamily: "Georgia, serif", fontSize: "1.8rem", fontWeight: 400 }}
                >
                  {item.num}
                </p>
      ...
      <div className="relative overflow-hidden min-h-[300px] md:min-h-[400px]">
        <img
          src="https://images.unsplash.com/photo-1561828995-aa79a2db86dd?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxqZXdlbHJ5JTIwZWFycmluZ3MlMjByaW5ncyUyMGx1eHVyeSUyMG1pbmltYWx8ZW58MXx8fHwxNzgzMjc4Mzk0fDA&ixlib=rb-4.1.0&q=80&w=1800"
