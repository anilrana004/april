...
const categories = [
  {
    label: "Necklaces",
    slug: "necklaces",
    image: "https://images.unsplash.com/photo-1590548784585-643d2b9f2925?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    count: "142 styles",
  },
  {
    label: "Earrings",
    slug: "earrings",
    image: "https://images.unsplash.com/photo-1585619979778-74d1811821d1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    count: "98 styles",
  },
  {
    label: "Rings",
    slug: "rings",
    image: "https://images.unsplash.com/photo-1605089315599-ca966e96b56a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=600",
    count: "76 styles",
  },
  {
    label: "Bracelets",
        ...
        {categories.map((cat) => (
          ...
          >
            ...
            <div className="absolute bottom-0 left-0 right-0 p-5">
              <p className="text-white uppercase tracking-widest mb-1" style={{ fontSize: "0.78rem", letterSpacing: "0.18em" }}>
                {cat.label}
              </p>
